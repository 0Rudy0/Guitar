...
<head><title>Default Page</title>
	...
	<script type="text/javascript">
		window.location += 'GuitarSongs2';
	</script>
</head>
<body>Dear customer,<br />
	<br />
	This is a temporary homepage we created to show that your temporary URL is working properly.<br />
	You MUST delete this page before or after you upload your own webpage. The file name of this page is "Default.asp" and it's located in your site root folder.<br />
	<br />
	Thank you.</body></html>